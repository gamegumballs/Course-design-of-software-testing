...
<div style="height:300px;padding-top:50px;padding-left:50px;">
  ...
  <div style="float:left">
    ...
    <div style="height:100px">
      ...
      <div style="float:left;padding-top:78px;"><form action="shopPage.jsp"><input type="hidden" name="toshop" value="<%=res.getString("shop_name")%>"><input type="submit" value="进店看看"></form></div>
      <div style="float:right;padding-top:78px;"><a href="MainPage.jsp">返回</a></div>
    </div>
  </div>
<%
	}
